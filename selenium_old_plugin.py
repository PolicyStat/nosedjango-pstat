...
class SeleniumOldPlugin(Plugin):
    name = 'selenium-old'
    ...
    def get_driver(self):
        from selenium_old.webdriver import Firefox as FirefoxWebDriver
        from selenium_old.webdriver import Chrome as ChromeDriver
        from selenium_old.webdriver import Remote as RemoteDriver
